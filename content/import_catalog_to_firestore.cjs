/**
 * Hemet Valley Tools - Firebase Catalog Importer & Seeding Utility (CommonJS Version)
 * 
...
const db = getFirestore(admin.app(), "hemetvalleytools");
...
if (command === "seed") {
  ...
  if (!filePath) {
    console.error("Please specify the path to your CSV catalog file. e.g., node import_catalog_to_firestore.cjs csv ./my_tools.csv");
  } else {
