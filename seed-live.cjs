...
// Direct initialization to the live GCP production instance
admin.initializeApp({
...
async function seed() {
  ...
  console.log('Seeding live GCP production Firestore with all collections...');
  ...
  console.log('Database seeding successfully completed on Live GCP production!');
}
